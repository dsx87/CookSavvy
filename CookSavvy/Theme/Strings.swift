...
enum Strings {
    ...
    enum Settings {
        ...
        static let trialPlanTitle = String(localized: "settings.trialPlanTitle", defaultValue: "CookSavvy+ Trial")
        static let trialDescription = String(localized: "settings.trialDescription", defaultValue: "Your 7-day free trial is active.")
        static let trialDescriptionWithDate = String(localized: "settings.trialDescriptionWithDate", defaultValue: "Your 7-day free trial is active until %@.")
    ...
    enum Upgrade {
        ...
        static let trialActiveSubtitle = String(localized: "upgrade.trialActiveSubtitle", defaultValue: "Your 7-day free trial is active.")
        ...
        static let tryFreeForSevenDays = String(localized: "upgrade.tryFreeForSevenDays", defaultValue: "Try free for 7 days")
        static let monthlyOptionTitle = String(localized: "upgrade.monthlyOptionTitle", defaultValue: "Monthly")
        static let annualOptionTitle = String(localized: "upgrade.annualOptionTitle", defaultValue: "Annual")
        static let bestValue = String(localized: "upgrade.bestValue", defaultValue: "Best value")
        static let freeTrialBadge = String(localized: "upgrade.freeTrialBadge", defaultValue: "7-day free trial")
        static let trialActive = String(localized: "upgrade.trialActive", defaultValue: "Trial active")
        static let annualSavingsFormat = String(localized: "upgrade.annualSavingsFormat", defaultValue: "Save %@ per year")
        static let annualSavingsFallbackAmount = String(localized: "upgrade.annualSavingsFallbackAmount", defaultValue: "$20")
        static let savingsAmountNumberFormat = String(localized: "upgrade.savingsAmountNumberFormat", defaultValue: "%.2f")
        ...
        static let monthlyTrialPriceFormat = String(localized: "upgrade.monthlyTrialPriceFormat", defaultValue: "7 days free, then %@/month")
        static let monthlyTrialActivePriceFormat = String(localized: "upgrade.monthlyTrialActivePriceFormat", defaultValue: "Free until %@, then %@/month")
        static let annualPriceFormat = String(localized: "upgrade.annualPriceFormat", defaultValue: "%@/year")
