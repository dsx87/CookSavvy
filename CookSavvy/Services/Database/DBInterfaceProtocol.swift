...
///
/// Defines every read and write operation against the SQLite database, covering the full
/// set of domain objects: ingredients, recipes, recent history, favourites, saved searches,
