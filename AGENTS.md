...
> **DO NOT run UI tests** — UITests are disabled in all test plans and must not be executed by agents or any automated tool. They require manual execution only.
