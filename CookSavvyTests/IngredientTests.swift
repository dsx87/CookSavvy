...
final class IngredientTests: XCTestCase {
    ...
    @MainActor
    func testKnownFoodGroupMappings() async {
    ...
    @MainActor
    func testNilFoodGroupDefaultsToOther() async {
        XCTAssertEqual(makeIngredient(foodGroup: nil).category, .other)
    }

    @MainActor
    func testUnknownFoodGroupDefaultsToOther() async {
    ...
    @MainActor
    func testIngredientAmountConvertsBetweenVolumeUnits() async {
    ...
    @MainActor
    func testIngredientAmountConvertsBetweenMassUnits() async {
    ...
    @MainActor
    func testIngredientAmountDoesNotConvertIncompatibleUnits() async {
        let amount = IngredientAmount(value: 1, unit: .cup)
    ...
    @MainActor
    func testIngredientAmountPreservesMatchingUncountableUnit() async {
